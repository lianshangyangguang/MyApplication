...
public class DragImageView extends ImageView {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (endTime - startTime < 100 || tag == 1) {
    ...
    int first = 0;
    int lastLeft = 0, lastTop = 0;

    /**
     * 移动的处理
     **/
    void onTouchMove(MotionEvent event) {
        Log.d("zxy", "onTouchMove: ");
...
//            }
            if (isControl_H || isControl_V || count == 1)  {
                int disX = 2;
                int disY = 2;
...
//                    bottom = current_y - start_y + this.getHeight();
                    ...
                    tag = 1;
                }else if (top - lastTop < 0 && (Math.abs(left - lastLeft) > 10 || Math.abs(top - lastTop) > 10)) {
//                    left = current_x - start_x;
//                    right = current_x + this.getWidth() - start_x;
//                    top = current_y - start_y;
//                    bottom = current_y - start_y + this.getHeight();
                    ...
                    right += (disX - 3);
                    bottom += (disY - 3);
                    Log.d("zxy", "left: " + left + ",lastLeft:" + lastLeft + "top:" + top + "," + "right:" + right + "," + "bottom:" + bottom);
                    this.setPosition(left, top, right, bottom);
                    if (onClickListener != null) {
